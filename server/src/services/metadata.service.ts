...
export class MetadataService extends BaseService {
  ...
  private async applyTaggedFaces(
    ...
    const missingWithFaceAsset: { faceClusterId: string; ownerId: string; faceAssetId: string }[] = [];
    ...
    for (const region of adjustedRegionInfo.RegionList) {
      ...
      if (!existingNameMap.has(loweredName)) {
        ...
        missingWithFaceAsset.push({ faceClusterId, ownerId: asset.ownerId, faceAssetId: face.id });
      }
    }
